  ...
  return (
    ...
    {data[actualFrame].component}
      <Pressable style={{flexDirection:'row', justifyContent:'space-around'}}>
        <Pressable style={{alignSelf:'center',paddingVertical:10}}  onPressIn={()=> actualFrame > 0 && setActualFrame(actualFrame -1 )} >
      ...
      <AntDesign name="leftcircle" size={30} color="black" /> 
        ...
        <Pressable style={{alignSelf:'center',paddingVertical:10}}  onPressIn={()=> actualFrame < cantFrames-1 && setActualFrame(actualFrame + 1)}>
